...
namespace projetJeu
{
    ...
    public class EnnemiSpinner : EnnemiSprite
    {
        ...
        public EnnemiSpinner(float x, float y)
            : base(x, y)
        {
            this.Initialize();
            this.Health = 2f;
        ...
        public EnnemiSpinner(Vector2 position)
        ...
        public static void LoadContent(ContentManager content, GraphicsDeviceManager graphics)
        {
            ...
            texture = content.Load<Texture2D>("Ennemi/ennemi-spinner.png");
        }
        ...
        private float remainingDelay = 0.25f;
        ...
        public override void Draw(float angle, Camera camera, SpriteBatch spriteBatch, SpriteEffects effects = SpriteEffects.None)
        {
            ...
            spriteBatch.Draw(this.Texture, this.Position, null, Color.White, this.angleRotation, origine, this.echelle, effects, 0f);
